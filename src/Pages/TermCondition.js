        ...
        <div className="lg:w-[500px] lg:h-full support-main bg-[#fff] md:w-[400px] flex flex-col">
          ...
          <div>
            <div className="m-5 p-2">
              <p>Welcome to fiewin!</p>
              <p>
                These terms and conditions outline the rules and regulations for
                the use of fiewin's Website, located at https://fiewin.org/.
              </p>

              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use fiewin if you do not agree to
              ...
              <p>
                We employ the use of cookies. By accessing fiewin, you agreed to
                use cookies in agreement with the fiewin's Privacy Policy.{" "}
              </p>
              ...
              <p>
                Unless otherwise stated, fiewin and/or its licensors own the
                intellectual property rights for all material on fiewin. All
                intellectual property rights are reserved. You may access this
                from fiewin for your own personal use subjected to restrictions
                set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from fiewin</li>
                <li>Sell, rent or sub-license material from fiewin</li>
                <li>Reproduce, duplicate or copy material from fiewin</li>
                <li>Redistribute content from fiewin</li>
              </ul>
              ...
              <p>
                ...
                website. fiewin does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of fiewin,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, fiewin shall not be liable for the
              ...
              <p>
                fiewin reserves the right to monitor all Comments and to remove
              ...
              <p>
                You hereby grant fiewin a non-exclusive license to use,
              ...
              <p>
                ...
                of fiewin; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to fiewin. Please include your name, your
              ...
              <p>
                No use of fiewin's logo or other artwork will be allowed for
