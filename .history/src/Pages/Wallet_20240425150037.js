...
const Wallet = () => {
  const [selectedAmount, setSelectedAmount] = useState("35 ~ 20000");
        ...
        <div className="lg:w-[500px] lg:h-full wallet-first bg-white md:w-[400px] ">
          ...
          <div className="mt-16">
            ...
            <div className="ml-3 mr-3">
              ...
              <input type='text' className="text-[#A1A1A1] outline-none" placeholder="₹35 ~ 20000" min={} />
                ₹ <span className="text-[#A1A1A1]">{selectedAmount}</span>
              </div>
              <hr />
            </div>
