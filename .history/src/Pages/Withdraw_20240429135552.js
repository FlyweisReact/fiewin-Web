    ...
    <>
      {withdraw ? (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 z-50">
          <div className="w-[400px] h-[250px] bg-white  rounded-lg relative p-5">
            <div className="font-semibold text-xl flex justify-center">
              Login to Withdraw
            </div>

            <form>
              <div className="flex justify-center flex-col items-center mt-5 gap-3">
                <div className="">
      ...
      <div className="h-screen flex justify-center">
        <div className="grid place-items-center ">
          <div className="lg:w-[500px] lg:h-full bg-white flex flex-col ">
            ...
            <ComponentHead  title={"Withdraw"} subTitle={""} />
              ...
              <div className="">
                ...
                <div className="p-6">
                  ...
                  <div className="text-2xl">
                    ₹ <span className="text-[gray]"> 40~100000 </span>
                  </div>
                  <hr />
                ...
                <div className="mt-10 flex justify-center ">
                  <button
                    className="bg-[#D3D3D3] rounded-xl withdraw-btn w-[450px] h-[48px] text-white text-xl font-bold"
