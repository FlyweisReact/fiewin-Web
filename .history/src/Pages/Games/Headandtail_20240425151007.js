...
import { get_module } from "../../Repository/Repository";
const Headandtail = () => {
  ...
  const getRules = () => {
    get_module({
      url : "headTail/headTailRule" ,setRe
    })
  }
          ...
          <div className="h-[400px] bg-gradient-to-t  from-[#001829] to-[#00538F]">
            {showRulesPopup && (
              <div className="rules-popup overflow-y-auto  headtail-rule z-50">
                ...
                <div>
                  15 seconds 1 issue, 12 seconds to order, 3 seconds to show the
                  lottery result. It opens all day. The total number of trade is
                  2880 issues.
                </div>
                <div>
                  If you spend 100 rupees to trade, after deducting 6 rupees
                  service fee, your contract amount is 94 rupees:
                </div>
                <div className="m-2">
                  <ul>
                    <li className="font-bold list-decimal">
                      JOIN HEAD: if the result shows Head, you will get (94 * 2)
                      188 rupees.
                    </li>
                    <li className="font-bold list-decimal">
                      JOIN TAIL: if the result shows Tail, you will get (94 * 2)
                      188 rupees.
                    </li>
                  </ul>
                </div>
            ...
            <div className="flex justify-center gap-2 mt-10">
              <div className="flex flex-col gap-2 items-center">
                <button className="bg-[#A5814F] head-tail-btn w-[220px] h-[60px] text-white font-bold rounded-lg text-xl">
                  Head
                </button>
                <span className="text-white">1.2</span>
              </div>
              <div className="flex flex-col gap-2 items-center">
                <button className="bg-[#FFB800] head-tail-btn w-[220px] h-[60px] text-white font-bold rounded-lg text-xl">
                  Tail
                </button>
                <span className="text-white">1.2</span>
              </div>
            ...
            <div className="bg-white border-t-2 rounded-t-xl relative mt-5">
              ...
              <div className="flex justify-center">
                <div className="flex justify-around items-center border-2 rounded-lg mt-5 p-2 w-[450px]">
                  <div className="w-[130px] flex flex-wrap gap-1">
                    <div className="w-[60px] head-tail-small h-[40px] bg-[#BEEBFF] flex justify-center items-center rounded-lg">
                      20
                    </div>
                    <div className="w-[60px] head-tail-small h-[40px] bg-[#BEEBFF] flex justify-center items-center rounded-lg">
                      50
                  ...
                  <div>
                    <div className="w-[170px] head--tail-medium h-[80px] text-2xl bg-[#BEEBFF] underline flex justify-center items-center rounded-lg">
                      ₹10
                    </div>
                  </div>
                  <div className="flex flex-col gap-1">
              ...
              <div className="mt-2 flex justify-center">
                <button className="bg-[#ED1B24] head-tail-confirm-btn w-[450px] h-[50px] rounded-lg font-bold text-white  ">
                  Confirm
                </button>
              </div>
