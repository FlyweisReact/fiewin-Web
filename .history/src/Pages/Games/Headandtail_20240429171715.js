            ...
            <div className="bg-white border-t-2 rounded-t-xl relative mt-5">
              ...
              <div className="flex justify-center">
                <div className="flex justify-around items-center border-2 rounded-lg mt-5 p-2 w-[450px]">
                  ...
                  <div>
                  <input type={'number'}  className="w-[170px] head--tail-medium h-[80px] text-2xl bg-[#BEEBFF] underline flex justify-center items-center rounded-lg" style={{outline  : "none"  , textAlign : 'center'}}  placeholder='₹10' />
