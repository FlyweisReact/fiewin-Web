...
const Headandtail = () => {
  ...
  const [allOrder, setMyOrder] = useState([]);
            ...
            <form onSubmit={handleSubmit}>
              <div className="bg-white border-t-2 rounded-t-xl relative mt-5">
                ...
                <div className="border-2 pb-2 mt-2 rounded-t-xl shadow-[0_3px_10px_rgb(0,0,0,0.2)] h-[300px]">
                  ...
                  <div className={`w-[250px] h-[50px] flex justify-center items-center border-b cursor-pointer ${type === "all-order" && 'border-black'}`}
                    onClick={() => setType("all-order")}>
                      Everyone's Order
                    </div>
                    <div className={`w-[250px] h-[50px] flex justify-center items-center border-b cursor-pointer ${type === "my-order" && 'border-black'}`}
