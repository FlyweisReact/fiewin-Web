            ...
            <div className="flex mt-2 gap-1 ">
              <div className="flex flex-col gap-1">
                <div className="flex gap-1 w-[450px] headtail-mini-main ">
                  ...
                  {myOrder?.map(( i ,index) => (
                    i.Select ==== "head" ?   <span className="w-[47px] headtail-mini h-[57px] bg-[#B49366] rounded flex justify-center items-center font-bold text-xl">
                    {" "}
                    H
                  </span>
                  ))}
                        ...
                        <tbody>
                          {myOrder?.map((i, index) => (
                            <tr key={`order${index}`}>
                              ...
                              <td>
                                {" "}
                                <div className={`headandTail  ${i.Select === "head" ? "H" : "T"} `} >
                                  {i.Select === "head" ? "H" : "T"}
                                </div>{" "}
                              </td>
                              <td>
                              <div className={`headandTail  ${i.result === "head" ? "H" : "T"} `} >
                                  {i.result === "head" ? "H" : "T"}
                                </div>
                              </td>
                              <td> ₹{i.money} </td>
